...
public class EquipoSonidoCons extends ElectrodomesticosCons {
    private  int precioVenta;
    private float consumoEnergetico, pesoKg;

    public EquipoSonidoCons(int precioVenta, float consumoEnergetico, float pesoKg, int referencia, String marca, int modelo, String color) {
